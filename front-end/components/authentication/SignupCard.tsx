  ...
  return (
    <View className="flex-1 w-full justify-center px-5">
      <View className="justify-center items-start mx-2 ">
        <Text className="text-white text-xl font-bold mb-2 tracking-[5]">
          Enter Your Details
        </Text>
      </View>
      <View className="my-1">
        <Text className="text-white font-semibold text-base px-3 my-2">
          First Name
        </Text>
        <View className={`bg-white flex-row items-center px-2 rounded-full`}>
          <TextInput
