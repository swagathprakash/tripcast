...
const ItenaryDetails = ({ tripId }: { tripId?: string | string[] | undefined }) => {
  ...
  const saveItinerary = () => {
    ...
    !loading && !userLoading && user && user.user_id && tripDetails && dispatch(saveItinaray({ userId: user.user_id, tripDetails: tripDetails }))
  }
  return (
    <>
